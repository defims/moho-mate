-- test_encode_apng.lua
-- 通过 IPC 测试 encode APNG 功能

local input_pattern = "/tmp/test_encode_frames/frame_%04d.png"
local output_path = "/tmp/test_encode_output.apng"

print("=== 测试 encode APNG ===")
...
-- 测试 encode
local success, msg = ipc.encode_video(input_pattern, output_path, {fps = 10})
